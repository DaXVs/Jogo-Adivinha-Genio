...
public class telaGenio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblFrase, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 40, 140, 70));
        ...
        getContentPane().add(txtVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 40, -1));
        ...
        getContentPane().add(btnPalpite, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 210, -1, -1));
    ...
    private void btnPalpiteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPalpiteActionPerformed
        ...
        //SORTEIO DO NÚMERO
        n = 1+Math.random()*(6-1);
        int valorsort = (int) n; //coloquei inteiro, para não ter o resultado como por ex.: 4.99 ou 3.56, etc.
        
        //PEGAR VALOR DO USUÁRIO
        palp=Integer.parseInt(txtVal.getValue().toString());
        
        //PEGANDO AS RESPOSTAS
        String r1 = ("ACERTOU!");
        String r2 = ("<html>ERROU! Eu pensei no valor " + valorsort+"."+"</html>");
        
        //COLOCANDO RESPOSTA NO lblFrase.
        String res = (palp==valorsort) ? r1 : r2;
        
        //ALTERANDO A FONTE DE ACORDO COM A RESPOSTA.
        if(res==r1) {
